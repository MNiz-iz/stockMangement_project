...
public class ViewSell extends javax.swing.JFrame {
    ...
    public ViewSell() {
        initComponents();
        showSellingDetail(); //show detail about selling
    }
    ...
    //for show detail of sell
    private void showSellingDetail() {
        try {
            Conn = DriverManager.getConnection(url,user,pass);
            St = Conn.createStatement();
            Rs = St.executeQuery("select Bid, Bdate, Btotal, Bdiscount, Bprofit from bill");
    ...
    private void initComponents() {
        ...
        jLabel21.setForeground(new java.awt.Color(159, 226, 191));
        ...
        jLabel5.setText("DETAIL of SELLs");

        sellingTable.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        sellingTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ID bill", "Date", "Total", "discount", "Profit"
            }
        ));
        sellingTable.setRowHeight(29);
        sellingTable.setRowMargin(1);
        sellingTable.setShowGrid(false);
        sellingTable.setShowHorizontalLines(true);
